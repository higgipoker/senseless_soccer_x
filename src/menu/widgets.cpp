...
void init_calibrate_widget (Widget* widget, Menu* menu) {
    ...
    circle(menu, widget->calibrate.origin_circle).setPosition ({942.f, 414.f});
    ...
    circle(menu, widget->calibrate.input_circle).setPosition ({942.f, 414.f});
    ...
    circle(menu, widget->calibrate.outer_circle).setPosition ({942.f, 414.f});
